...
describe("Description", () => {
  ...
  test("displays the correct description text at non-md breakpoint", () => {
  ...
  test("displays the correct description text at md breakpoint", () => {
    ...
    const descriptionHtml = wrapper
      .find('[data-testid="description-text-md"]')
      .html();
