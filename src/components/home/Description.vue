...
<template>
  ...
  >
    ...
    >
      「2023 新竹 X
      梅竹黑客松」延續前一屆種下的創意種子，迎接新一年的盛會期待百花綻放，在近年人工智慧與科技蓬勃發展的洪流下，我們邀請到六間國際級企業與新竹市政府，剖析世界所期待得到解答的問題，並提供相關資源與指導，引領所有參賽者成為關鍵的最後一塊拼圖。<br /><br />
      ...
      同時，我們延續自 2022
      活動十周年以來所建立的成果存放平台，持續翻新與維護該平台，致力於保留所有人最珍貴的好點子，希望自全國菁英歷年所奠定的基礎上，為新的一年啟發靈感與激盪嶄新想法，飲水思源之際，保有自強不息的精神，達成善的循環回饋社會。
    </div>
  </div>
  <div
  ...
  >
    ...
    <object
      ...
      type="image/svg+xml"
      class="absolute top-[54%] left-[0%]"
    ></object>
    <object
      data="/home/icon-ve26-2.svg"
      type="image/svg+xml"
      class="absolute top-[39%] left-[63%]"
    ></object>
    <object
      data="/home/icon-ve82-2.svg"
      type="image/svg+xml"
      class="absolute top-[51%] left-[90%]"
    ></object>
    <object
      data="/home/icon-ve83-2.svg"
      type="image/svg+xml"
...
.desc-co16 {
  animation: animateCo16 3.5s ease-out infinite;
}
