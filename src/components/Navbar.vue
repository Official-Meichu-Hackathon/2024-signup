  ...
  <nav class="fixed top-0 w-full h-[75px] bg-white">
    <div class="flex items-center justify-between mx-11 h-full">
      <div class="flex items-center justify-between gap-x-12 mt-1.5">
        ...
        <div class="text-base font-Inter font-medium text-[#222236]">比賽時程 testt</div>
        <router-link to="/TopicDesciption" class="text-base font-Inter font-medium text-[#222236]">題目說明 testt</router-link>
